require "./noto_cjk/version"
require "./noto_cjk/cache"
...
# NotoCjk::Cache.pull(variants: [:sc]) # ≈ 16 MB
#
# # Use as a font path in any TTF-aware library.
# if (path = NotoCjk.font_path)
...
module NotoCjk
  ...
  #
  # ```
  # NotoCjk.font_path      # => "/.../NotoSansCJKsc-Regular.otf" or nil
  # NotoCjk.font_path(:jp) # => "/.../NotoSansCJKjp-Regular.otf" or nil
  # ```
